...
// Receipt Class creates Product objects, which are created using the information from the input text file.
...
public class Receipt {
	...
	private LinkedList<Product> productsList = new LinkedList<Product>();
	...
	public Receipt(String inputFileName) {
		/*
		 * Receipt method accepts a directory to an input text file which it traverses
	...
	public void calculateTotals() {
		/*
		 * calculateTotals() method runs through the receipt's list of products in order
		 * to calculate the sales tax and total BigDecimals are used in order to avoid
		 * rounding errors
		 * 
		 */
	...
	public static int containsItemFromArray(String inputString, String[] items) {
		/*
		 * static int containsItemFromArray method returns the index of which String in
		 * items was found in the input String -1 is returned in none of the Strings in
		 * items are found in the inputString
		 */
		int index = -1;
	...
	public static BigDecimal round(BigDecimal value, BigDecimal increment, RoundingMode roundingMode) {
		/*
		 * static BigDecimal round() method makes rounding to 0.05, and also sets the
		 * BigDecimal numbers to use 2 decimals
		 * 
		 */
